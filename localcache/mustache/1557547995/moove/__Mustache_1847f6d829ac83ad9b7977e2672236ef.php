...
class __Mustache_1847f6d829ac83ad9b7977e2672236ef extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionEf012cca2aa921cbd5d035bcd5ba4dbe($context, $indent, $value);
        $buffer .= $indent . '</ul>';
...
';
    ...
    private function section284433ce4fd9b32d883d116fdbd1bfb9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        {{^is_section}}
                <li class="list-group-item list-group-item-action {{#isactive}}active font-weight-bold{{/isactive}}" data-key="{{key}}">
                    <a href="{{{action}}}">
                        <span class="text m-l-{{get_indent}}" style="margin-left: 6px!important">{{{text}}}</span>
                    </a>
                </li>
        {{/is_section}}
    ';
...
';
                    ...
                    $buffer .= call_user_func($this->mustache->getEscape(), $value);
                    $buffer .= '" style="margin-left: 6px!important">';
...
';
    ...
    private function sectionEf012cca2aa921cbd5d035bcd5ba4dbe(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            <li class="list-group-item" data-key="{{key}}">
                <a class="m-l-{{get_indent}} has-arrow" href="javascript:void(0);">
                    {{#is_section}}
                        {{#pix}}i/folder{{/pix}}
                    {{/is_section}}
                    <span class="text" style="margin-left: 6px!important">{{{text}}}</span>
                </a>
                <ul>
                    {{#children}}
                        {{^is_section}}
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section284433ce4fd9b32d883d116fdbd1bfb9($context, $indent, $value);
...
';
                    ...
                    $buffer .= $indent . '                    <span class="text" style="margin-left: 6px!important">';
                    $value = $this->resolveValue($context->find('text'), $context);
                    $buffer .= $value;
                    $buffer .= '</span>
';
