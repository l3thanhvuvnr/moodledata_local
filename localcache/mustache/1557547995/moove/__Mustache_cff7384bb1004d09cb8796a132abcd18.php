...
class __Mustache_cff7384bb1004d09cb8796a132abcd18 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section92ba784973765e84b712739b1cf02178($context, $indent, $value);
        $buffer .= '<a href="';
...
';
    ...
    private function section92ba784973765e84b712739b1cf02178(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="container-new">
	<div class="new-head" style="margin-left: 10px; margin-right: 10px;">
		<div class="row mb-3 mr-0">{{#btnaddnews}}{{{btnaddnews}}}{{/btnaddnews}}</div>
		<div class="row">
...
';
                $buffer .= $indent . '		<div class="row mb-3 mr-0">';
                // 'btnaddnews' section
