...
class __Mustache_9971aa90ece4b206cf423bd45a631940 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE30ec76004c916000f063c43687cd26b($context, $indent, $value);
        $buffer .= '<a href="';
...
';
    ...
    private function sectionE30ec76004c916000f063c43687cd26b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="container-new">
	<div class="new-head" style="margin-left: 10px; margin-right: 10px;">
		<div class="row mb-3 ml-0">{{#btnaddnews}}{{{btnaddnews}}}{{/btnaddnews}}</div>
		<div class="row">
...
';
                $buffer .= $indent . '		<div class="row mb-3 ml-0">';
                // 'btnaddnews' section
