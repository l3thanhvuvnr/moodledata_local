...
class __Mustache_f8d081289d144a3fe66a1b9fbcc5b122 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1fafed5ada2359f392eef3039b96eca6($context, $indent, $value);
        $buffer .= $indent . '            
';
...
';
        ...
        $buffer .= $this->sectionDfe564bf5bb34f9f3292e19e38c44df8($context, $indent, $value);
...
';
    ...
    private function section2e4a026838ae4575cc781abe848c57aa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                    {{>theme_moove/fp_slideshow}}
...
';
    ...
    private function section1fafed5ada2359f392eef3039b96eca6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section2e4a026838ae4575cc781abe848c57aa($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function sectionDfe564bf5bb34f9f3292e19e38c44df8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '              <div class="clearf-ix"></div>
';
                $buffer .= $indent . '          </div>
';
                $context->pop();
